...
//        zoomImg(this.currentBitmap, 800, 1280);
        currentBitmap = Bitmap.createScaledBitmap(currentBitmap, ScreenUtils.getScreenWidth(), ScreenUtils.getScreenHeight(), true);
        Drawable drawable = ConvertUtils.bitmap2Drawable(currentBitmap);
    ...
    private void init() {
        ...
        //线条粗细
        mDrawSize = ConvertUtils.dp2px(5);
